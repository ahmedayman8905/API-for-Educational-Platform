    ...
    public partial class Createtables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Admins__3214EC0755447CE2", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Categori__3214EC0777F78313", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__instruct__3214EC0774467063", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Students__3214EC07CEC34D09", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Courses__3214EC07056A0E8A", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Courses__cate_id__1920BF5C",
                        column: x => x.cate_id,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__Courses__instruc__1A14E395",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RefreshTokens_Student_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    cours_id = table.Column<int>(type: "int", nullable: true),
                    LecuerNumber = table.Column<string>(type: "nchar(100)", fixedLength: true, maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Material__3214EC077B3D4884", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Material__cours___1CF15040",
                        column: x => x.cours_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    star_tdate = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValueSql: "(getdate())")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Regestra__5A06028E7BAC8DD1", x => new { x.Student_id, x.course_id });
                    table.ForeignKey(
                        name: "FK__Regestrat__Stude__21B6055D",
                        column: x => x.Student_id,
                        principalTable: "Student",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Regestrat__cours__22AA2996",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Material_cours_id",
                table: "Material",
                column: "cours_id");

            migrationBuilder.CreateIndex(
                name: "IX_Regestration_course_id",
                table: "Regestration",
                column: "course_id");
        }
